...
TARGET_LINK_LIBRARIES(${TUTORIAL_NAME} ${EMBREE_LIBRARY} ${TBB_LIBRARIES} tutorial image transport tutorial_device ${ADDITIONAL_LIBRARIES})
...
IF (ENABLE_ISPC_SUPPORT)
  ...
  TARGET_LINK_LIBRARIES(${TUTORIAL_NAME}_ispc ${EMBREE_LIBRARY} ${TBB_LIBRARIES} tutorial tasking image transport tutorial_device_ispc)
...
IF (ENABLE_XEON_PHI_SUPPORT)
  ...
  ELSE()
    ...
    TARGET_LINK_LIBRARIES(${TUTORIAL_NAME}_xeonphi_device ${EMBREE_LIBRARY_XEONPHI} transport_device tutorial_xeonphi_device_ispc)
